...
const NextArrow = ({ onClick }) => {
  return (
    <button className="nexticon-btnn" onClick={onClick}>
...
const PrevArrow = ({ onClick }) => {
  return (
    <button className="backicon-btnn" onClick={onClick}>
...
function FindDoc2() {
  ...
  const qnda = [
    ...
    {
      question: "Can I consult with a doctor from the comfort of my home?",
      answer:
    ...
    {
      question: "How do I know if the doctor I want to see is available on a specific day?",
      answer:
  ...
  return (
    <>
      <Hero />
      <div className="unselected-doc-prof d-flex" id="finddocpage2">
        <div className="unselected-profile mt-5 mb-5">
          <div className="col-lg-12 col-md-12">
            <div className="unselected-doc d-flex">
              <div className="unselected-doc-img col-lg-2 col-md-3">
                <img src={doctor} alt="" />
              </div>
              <div className="unselected-doc-info d-flex flex-column col-lg-6 col-md-5">
                <div className="unselected-doc-part1 d-flex flex-column mt-5">
                  ...
                  <div className="unselected-doc-part2 d-flex col-md-12 mt-3">
              ...
              <div className="unselected-doc-ratings d-flex flex-column col-lg-3 col-md-4 mt-5">
            ...
            <div className="tab-content" id="pills-tabContent">
              ...
              >
                <div className="tab-content-container">
                  <div className="tab-info-content-left col-6 mt-4">
                    ...
                    <div className="tab-info-content-right col-6 mt-4">
                      <CalendarComponent />
                    </div>
                </div>
              </div>
      ...
      <div className="tbunselected-doc-prof d-flex" id="finddocpage2">
        <div className="tbunselected-profile d-flex flex-column mt-3 mb-5">
          <div className="tbunselected-doc d-flex flex-column">
            <div className="tbunselected-doc-up d-flex">
              <div className="tbunselected-doc-img mt-4">
                <img src={doctor} alt="" />
              </div>
              <div className="tbunselected-doc-info d-flex flex-column">
                <div className="tbunselected-doc-part1 d-flex flex-column mt-4">
                  <span className="tbspanh1">Dr. Zara Hussain</span>
                  <span className="tbspanh5">
                    Professor and Consultant of Cardiology & Cardiovascular diseases - AL Azhar university
                  </span>
                  <div className="tbunselected-rating1 d-flex flex-column">
                    <img src={star} alt="star" className="tbunselected-doc-star" />
                    <span className="tbunselected-doc-visitors">Overall Rating From 248 Visitors</span>
                  </div>
                </div>
                <div className="tbunselected-rating2 d-flex mt-3">
                  <img src={verified} alt="green-icon" />
                  <span className="tbunselected-doc-vtext">Medical Registration Verified</span>
                </div>
                <span className="tbunselected-doc-exp">06 Years Experience</span>
              </div>
            </div>
            <div className="tbunselected-doc-part2 d-flex mt-3">
              <span>Cardiologist</span>
              <span> Adult Cardiology</span>
              <span>Pediatric Cardiolog</span>
              <span> Vascular Diseases</span>
          ...
          <div className="tbunselected-about">
            <hr className="tbunselected-doc-hr" />
            <span className="tbunselected-doc-about mt-3">
              Dr. Sara Hussain is a Cardiology and Vascular Diseases Specialist, serving as an Associate Professor of Cardiology at a prestigious Indian university. With expertise in Interventional Cardiology, Dr. Hussain completed her fellowship at Yonsei University, Seoul, South Korea. Please note that appointments on Guide care are reserved exclusively for patients.
            </span>
          </div>
          <div className="tbunselected-doc-tabs mt-4">
            <ul className="nav-pills d-flex mb-3" id="pills-tab" role="tablist">
              <li className="nav-pills-item" role="presentation">
                <button
              ...
              <li className="nav-pills-item" role="presentation">
                <button
                  className={`nav-link ${activeTab === "qanda" ? "active" : ""}`}
                  onClick={() => handleTabClick("qanda")}
                  type="button"
                  role="tab"
                  aria-selected={activeTab === "qanda"}
                >
                  Consult Q & A
                </button>
              </li>
            ...
            <div className="tab-content" id="pills-tabContent">
              <div className={`tab-pane fade ${activeTab === "info" ? "show active" : ""}`} role="tabpanel">
                <div className="tbtab-content-container col-12">
                  <div className="tbtab-info-content-left d-flex flex-column col-md-6 mt-4">
                    <div className="tbtab-info-content-1 d-flex flex-column">
                      <div className="tbtab-info-content-1-1 mt-3 d-flex">
                        <img src={stethescope} alt="" />
                        <span>MBBS, MD General Medicine, DM Cardiology</span>
                      </div>
                      <div className="tbtab-info-content-1-2 mt-3 mb-3 d-flex">
                        <img src={location} alt="" />
                        <span>Neeladri Nagar, Electronic city Phase 4</span>
                      </div>
                    </div>
                    <div className="tbtab-info-content-2 mt-4">
                      <button className="tbtab-info-content-2-btn" type="btn">
                        Book Hospital Appointment
                      </button>
                    </div>
                    <div className="tbtab-info-content-3 mt-4">
                      <button className="tbtab-info-content-3-btn" type="btn">
                        Online Consult
                      </button>
                    </div>
                  </div>
                  <div className="tbtab-info-content-right col-md-6 mt-4">
                    <CalendarComponent />
                  </div>
                </div>
              </div>
              <div className={`tab-pane fade ${activeTab === "feedback" ? "show active" : ""}`} role="tabpanel">
                <div className="tbtab-feedback-content">
                  <Slider {...settings}>
                    <div className="tbtab-feedback-1 mt-5">
                      <img src={feed1} alt="" className="tbtab-feed1" />
                      <img src={blackstar} alt="" className="tbtab-black5 mt-2" />
                      <span className="tbtab-feed-1">
                        "Guide Care Medical Tourism exceeded my expectations. With their guidance, I found top-notch doctors and state-of-the-art facilities for my medical needs abroad. Their personalized approach made all the difference."
                      </span>
                      <span className="tbtab-feed-name1 mt-2 mb-3">Sarah W.</span>
                    </div>
                    <div className="tbtab-feedback-2 mt-5">
                      <img src={feed2} alt="" className="tbtab-feed2" />
                      <img src={blackstar} alt="" className="tbtab-black5 mt-2" />
                      <span className="tbtab-feed-2">
                        "Guide Care Medical Tourism exceeded my expectations. With their guidance, I found top-notch doctors and state-of-the-art facilities for my medical needs abroad. Their personalized approach made all the difference."
                      </span>
                      <span className="tbtab-feed-name2 mt-2 mb-3">Sarah W.</span>
                    </div>
                    <div className="tbtab-feedback-3 mt-5">
                      <img src={feed3} alt="" className="tbtab-feed3" />
                      <img src={blackstar} alt="" className="tbtab-black5 mt-2" />
                      <span className="tbtab-feed-3">
                        "Guide Care Medical Tourism exceeded my expectations. With their guidance, I found top-notch doctors and state-of-the-art facilities for my medical needs abroad. Their personalized approach made all the difference."
                      </span>
                      <span className="tbtab-feed-name3 mt-2 mb-3">Sarah W.</span>
                    </div>
                    <div className="tbtab-feedback-4 mt-5">
                      <img src={feed4} alt="" className="tbtab-feed4" />
                      <img src={blackstar} alt="" className="tbtab-black5 mt-2" />
                      <span className="tbtab-feed-4">
                        "Guide Care Medical Tourism exceeded my expectations. With their guidance, I found top-notch doctors and state-of-the-art facilities for my medical needs abroad. Their personalized approach made all the difference."
                      </span>
                      <span className="tbtab-feed-name4 mt-2 mb-3">Sarah W.</span>
                    </div>
                  </Slider>
                </div>
              </div>
              <div className={`tab-pane fade ${activeTab === "qanda" ? "show active" : ""}`} role="tabpanel">
                <div className="tbaccordion-containerdoc mb-4">
                  <div className="accordion" id="tbaccordion_Example_doc">
                    <div className="tbaccordion-doc-items">
                      {qnda.map((item, index) => (
                        <div className="accordion-item" key={index}>
                          <h2 className="accordion-header">
                            <button
                          ...
                          <div
                            ...
                            data-bs-parent="#tbaccordion_Example_doc"
                          >
                            <div className="tbaccordion-bodydoc">{item.answer}</div>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          <hr className="tbunselected-doc-hr2 mt-5" />
          <div className="tbunselected-clinic-block mt-4">
            <span className="tbclinic-hos">Clinic / Hospital images</span>
            <div className="tbclinic-hos-img mt-3 d-flex">
              <img src={clinic1} alt="" />
              <img src={clinic2} alt="" />
              <img src={clinic3} alt="" />
              <img src={clinic4} alt="" />
